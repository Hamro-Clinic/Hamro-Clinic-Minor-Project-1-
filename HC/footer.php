...
<body>
    <footer class="bg-dark text-white pt-md-3">
        <div class="footer-section">
            <div class="footer-links">
                ...
                <li>
                    <a class="nav-link" href="labreport.php">Lab Report</a>
                </li>
                <li>
        ...
        <div class="copyright-section text-center py-3 mt-3">
            <div>Hamro Clinic &copy; 2021.All Rights Reserved</div>
        </div>
    </footer>
