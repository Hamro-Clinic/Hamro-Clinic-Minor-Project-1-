...
<head>
    ...
    <script>
        function validateForm() {
            ...
            var count = 0;
            if (subject == "") {
                document.getElementById("para-subject").innerHTML = "Subject must be filled out";
                count++;
            }

            if (body == "") {
                document.getElementById("para-body").innerHTML = "Body must be filled out";
                count++;
            }
...
<body>
    ...
    <div class="main_content p-sm-0 p-md-2">
        ...
        ?>
        <div class="container-fluid shadow-lg table-responsive bg-white p-md-1">
